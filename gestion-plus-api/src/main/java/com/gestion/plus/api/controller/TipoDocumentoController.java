...
import com.gestion.plus.api.services.impl.TipoDocumentoServiceImpl;
...
public class TipoDocumentoController {
  ...
  @Operation(summary = "Operacion que permite crear tipo de documento")
  @ApiResponses(value = {
  ...
  public ResponseEntity<ResponseDTO> saveTipoDocumento(@RequestBody TipoDocumentoDTO tipoDocumentoDTO) {
    return this.tipoDocumentoServiceImpl.saveTipoDocumento(tipoDocumentoDTO);
  }
  
  @Operation(summary = "Operacion que permite consultar los tipos de documento")
  @ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se consulta exitosamente", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = ResponseDTO.class)) }),
			@ApiResponse(responseCode = "400", description = "La petición no puede ser entendida por el servidor debido a errores de sintaxis, el cliente no debe repetirla no sin antes hacer modificaciones", content = {
  ...
  public ResponseEntity<ResponseDTO> getAllTipoDocumento() {
    return this.tipoDocumentoServiceImpl.findAll();
  }
  
  @Operation(summary = "Operacion que permite consultar un tipo de documento a partir de un id")
  @ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se consulta exitosamente", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = ResponseDTO.class)) }),
			@ApiResponse(responseCode = "400", description = "La petición no puede ser entendida por el servidor debido a errores de sintaxis, el cliente no debe repetirla no sin antes hacer modificaciones", content = {
  ...
  public ResponseEntity<ResponseDTO> getTipoDocumentoId(@PathVariable Integer id) {
    return this.tipoDocumentoServiceImpl.findTipoDocumentoById(id);
  }
  
  @Operation(summary = "Operacion que permite actualizar tipo de documento a partir de un id")
  @ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se consulta exitosamente", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = ResponseDTO.class)) }),
			@ApiResponse(responseCode = "400", description = "La petición no puede ser entendida por el servidor debido a errores de sintaxis, el cliente no debe repetirla no sin antes hacer modificaciones", content = {
  ...
  public ResponseEntity<ResponseDTO> updateTipoDocumento(@PathVariable Integer id, @RequestBody TipoDocumentoDTO tipoDocumentoDTO) {
    return this.tipoDocumentoServiceImpl.updateTipoDocumento(id, tipoDocumentoDTO);
  }
  ...
  public ResponseEntity<ResponseDTO> deleteTipoDocumento(@PathVariable Integer id) {
    return this.tipoDocumentoServiceImpl.deleteTipoDocumento(id);
  }
}